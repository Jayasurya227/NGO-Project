...
function StatCard({ label, value, sub, icon: Icon, color, valueSize }: any) {
  const colors: any = {
  ...
  return (
    <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm hover:shadow-md transition-shadow group">
      ...
      <p className={`${valueSize ?? 'text-2xl'} font-bold text-slate-900 group-hover:text-blue-600 transition-colors`}>
        {value}
      </p>
